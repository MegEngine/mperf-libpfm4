/*
 * Neoverse E1 Event Table
 */
static const arm_entry_t arm_neoverse_e1_pe[]={
	{.name = "SW_INCR",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0x00,
	...
	{.name = "L2D_CACHE",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0x16,
	 .desc = "Level 2 unified cache access"
	},
	{.name = "L2D_CACHE_REFILL",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0x17,
	 .desc = "Level 2 unified cache refill"
	},
	{.name = "L2D_CACHE_WB",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0x18,
	 .desc = "Level 2 unified cache Write-Back"
	},
	{.name = "BUS_ACCESS",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0x19,
	...
	{.name = "L2D_CACHE_ALLOCATE",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0x20,
	 .desc = "Level 2 unified cache allocation without refill"
	},
	{.name = "BR_RETIRED",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0x21,
	...
	{.name = "L2_L2D_CACHE_UNATT",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0xf1,
	 .desc = "Unattributable Level 2 unified cache access"
	},
	{.name = "L2_L2D_CACHE_RD_UNATT",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0xf2,
	 .desc = "Unattributable Level 2 unified cache access, read"
	},
	{.name = "L2_L3D_CACHE_UNATT",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0xf3,
	 .desc = "Unattributable Level 3 unified cache access"
	},
	{.name = "L2_L3D_CACHE_RD_UNATT",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0xf4,
	 .desc = "Unattributable Level 3 unified cache access, read"
	},
	{.name = "L2_L3D_CACHE_ALLOC_UNATT",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0xf5,
	 .desc = "Unattributable Level 3 unified cache allocation without refill"
	},
	{.name = "L2_L3D_CACHE_REFILL_UNATT",
	 .modmsk = ARMV8_ATTRS,
	 .code = 0xf6,
	 .desc = "Unattributable Level 3 unified cache refill"
	},
	...
	/* END Neoverse E1 specific events */
};
